...
def main():
    ...
    img_size = 28
    train_data = Imgdataset(train_file_img, img_size, transform=[transforms.ToTensor()])#transforms.Normalize(mean=dataset_mean,std=dataset_std)
...
class Imgdataset(data.Dataset):
    def __init__(self, img_folder, img_size=28, transform=[], train=False, channel=3):
